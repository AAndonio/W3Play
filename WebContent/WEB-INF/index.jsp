...
<body>
	<div id="page">
		...
		<div class="main-content">
			<ul class="bxslider">
				<li><img class="image-slider" src="img/tab1.jpg"
					alt="Immagine gioco Tom Clancy's The Division"></li>
				<li><img class="image-slider" src="img/tab2.jpg"
					alt="Immagine gioco Tom Clancy's The Division"></li>
				<li><img class="image-slider" src="img/tab3.jpg"
					alt="Immagine gioco Tom Clancy's The Division"></li>

			</ul>
			<div class="main-latest-products">
				<h4>Ultimi arrivi</h4>
				<%
					ArrayList<Prodotto> ultimiArrivi = (ArrayList<Prodotto>) request.getSession().getAttribute("ultimiArrivi");
					for (Prodotto p : ultimiArrivi) {
				%>
				<div class="latest-product">
					<a
						href="productServlet?id=<%=p.getIdProdotto()%>&action=directUltimiArrivi"><img
						src="<%=p.getImmagine()%>" alt="Ultimo prodotto arrivato"></a>
					<p class="product-console"><%=p.getPiattaforma()%></p>
					<a class="product-title"
						href="productServlet?id=<%=p.getIdProdotto()%>&action=directUltimiArrivi">
						<%=p.getNome()%></a>
			...
			<div class="main-latest-products">
				<h4>I pi&uacute; venduti</h4>

				<%
					ArrayList<Prodotto> piuVenduti = (ArrayList<Prodotto>) request.getSession().getAttribute("piuVenduti");
					for (Prodotto p : piuVenduti) {
				%>
				<div class="latest-product">
					<a
						href="productServlet?id=<%=p.getIdProdotto()%>&action=directPiuVenduti"><img
						src="<%=p.getImmagine()%>" alt="Prodotto piu venduti"></a>
					<p class="product-console"><%=p.getPiattaforma()%></p>
					<a class="product-title" href="#"> <%=p.getNome()%></a>
					<p class="product-price">
						<%=p.getPrezzo()%>&euro;
					</p>
				</div>
